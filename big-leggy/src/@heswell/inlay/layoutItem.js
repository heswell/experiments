...
import {getLayoutModel} from './container';
...
export default class LayoutItem extends React.Component {
    ...
    handleAction = (key, opts) => {
        ...
        if (key === 'menu') {
            ...
            var { left, top } = opts;
            var actionHandler = this.handleContextMenuAction;

            // the ComponentContextMenu will reach into the hostedComponent to get MenuItems, we should do that here
            var contextMenu = <ComponentContextMenu component={this} doAction={actionHandler} />;
