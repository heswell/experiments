  ...
  return (
    <LayoutToolbar style={props.style}>
      <LayoutToolbarContext.Provider value={{alignItems, flexDirection, justifyContent}}>
        <select value={flexDirection} onChange={e => handleChange("flexDirection", e.target.value)}>
          <option value="row">Row</option> 
          <option value="column">Column</option> 
        </select>
        <ToolbarInnerContainer>
        <StateButton.Group className="StateButtonGroup" name="alignItems" onChange={handleChange} value={alignItems}>
        ...
        <StateButton.Group className="StateButtonGroup" name="justifyContent" onChange={handleChange} value={justifyContent}>
          <StateButton label="Start" value="flex-start" >
