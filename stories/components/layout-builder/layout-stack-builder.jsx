...
import { Flexbox,  Component as PlaceHolder, DraggableLayout, Stack, View } from '@heswell/layout';
  ...
  return (
    <DraggableLayout style={{width: '100vw', height: '100vh'}}>
      ...
      <Flexbox style={{ flexDirection: 'row', flex: 1 }}>
        <View className="builder-top" style={{width: 140, backgroundColor: 'rgb(90,90,90)'}}>
            <Palette orientation="vertical" style={{backgroundColor: 'inherit'}}/>
          </View>
          <DraggableLayout style={{flex:1}} dropTarget onLayoutModel={onLayoutModel}>
            <Stack showTabs style={{width: '100%', height: '100%'}}>
              ...
              <View title="Page 2"  style={{flex: 1}}>
                <PlaceHolder style={{width: '100%',height: '100%', backgroundColor: 'yellow'}} resizeable/>
              </View>
            </Stack>
        </DraggableLayout>
