...
const Logo = forwardRef(function Logo(props, ref) {
  ...
  return (
    <span
      className={classnames(classes.root, className, densityClassName)}
      ref={ref}
      style={{
        height,
      }}
    ...
    >
      ...
      <Title
        defaultClassName={classes.appTitle}
        height={height}
        label={appTitle}
        separatorClassname={classnames(classes.titlePipe, {
          [classes.compact]: isCompactVariant(variant),
        })}
        {...TitleProps}
      />
    </span>
