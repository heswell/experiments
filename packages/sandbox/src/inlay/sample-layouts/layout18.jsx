...
export default (width = 500, height = 400) =>
    <FlexBox style={{ width: 800, height: 500, flexDirection: 'row' }}>
        ...
        <FlexBox style={{ flex: 1, flexDirection: 'column' }} resizeable>
            <FlexBox style={{ height: 100, flexGrow: 1, flexShrink: 1, flexDirection: 'row' }} resizeable>
                <FlexBox style={{ flex: 1, flexDirection: 'column' }} resizeable>
            ...
            <Component title='B Component' style={{ height: 194, flexGrow: 1, flexShrink: 1, backgroundColor: 'blue' }} header resizeable />
            <Component title='R Component' style={{ height: 194, flexGrow: 1, flexShrink: 1, backgroundColor: 'red' }} header resizeable />
        </FlexBox>
    </FlexBox>
