...
function binaryInsert(rows, row, comparator) {
...
function sortedLowestAndHighest(rows, sortCriteria, offset, n = 1e3) {
...
function sortByToMap(sortCriteria = null) {
  return sortCriteria === null ? EMPTY_MAP : sortCriteria.reduce((map, col, i) => {
