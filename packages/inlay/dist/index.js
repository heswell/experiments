...
class MenuItem extends React.Component {
  ...
  render() {
    var nestedMenu = this.props.submenuShowing ? React.createElement(ContextMenu, {
      doAction: this.props.doAction
    }, this.props.children) : null;
    var className = cx('menu-item', this.props.disabled ? 'disabled' : null, this.state.hasChildMenuItems ? 'root' : null, this.props.submenuShowing ? 'showing' : null);
...
const Separator = () => React.createElement("li", {
  className: "divider"
});
