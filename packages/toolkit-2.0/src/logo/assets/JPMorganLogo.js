...
const dimensionsForDensity = {
  high: { width: 73, height: 15 },
  medium: { width: 91, height: 19 },
  low: { width: 102, height: 22 },
  touch: { width: 109, height: 23 }
};

const JPMorganLogo = forwardRef(function JPMorganLogo(
  { className = 'jpm-logo', density, style: styleProp, ...rest },
  ref
) {
  const style = { ...styleProp, marginTop: density === 'high' ? 1 : undefined };
  return (
    <svg
      className={className}
      role="img"
      ...
      style={style}
    >
      <title id="jpm-logo-graphic">J.P. Morgan</title>
      <path
