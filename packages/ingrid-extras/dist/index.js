...
const SetFilter = ({
  ...
  return React.createElement(FlexBox, {
    className: classnames('SetFilter', 'ColumnFilter', className),
    style: {
      width: 300,
      height,
...
class NumberFilter extends React.Component {
  ...
  render() {
    ...
    return React.createElement(FlexBox, {
      className: classnames('NumberFilter', 'ColumnFilter', className),
      style: {
        width,
        height,
        visibility: style.visibility
...
class MultiColumnFilter extends React.Component {
  render() {
    ...
    return React.createElement(FlexBox, {
      className: classnames('MultiColumnFilter', 'FilterPanel', className),
      style: {
        width,
        height
      }
...
const List$1 = ({
  ...
  const content = items.map((item, idx) => {
    ...
    const motionStyle = lastPressed.current === item && isPressed.current ? {
      scale: reactMotion_4(1.01, springConfig),
      shadow: reactMotion_4(16, springConfig),
      x: 0,
      y: mouse
      ...
      scale: reactMotion_4(1, springConfig),
      shadow: reactMotion_4(1, springConfig),
      x: reactMotion_4(0, springConfig),
      y: reactMotion_4(order.indexOf(idx) * 24, springConfig)
    } : {
      scale: reactMotion_4(1, springConfig),
      shadow: reactMotion_4(1, springConfig),
      x: 0,
    ...
    return React.createElement(reactMotion_1, {
      style: motionStyle,
      key: item.name
    }, ({
      scale,
  ...
  if (dragged.item && !onTarget) {
    const style2 = dragging ? {
      ...
      scale: reactMotion_4(1, springConfig),
      shadow: reactMotion_4(1, springConfig),
      x: reactMotion_4(dragOffsetX, springConfig),
      y: reactMotion_4(dragOffsetY, springConfig)
    };
    content.push(React.createElement(reactMotion_1, {
      style: style2,
      key: "dragged"
    }, ({
      scale,
...
class ColumnPicker extends Component {
  ...
  render() {
    ...
    var className = classnames(this.props.className, 'ColumnPicker');
    return React.createElement(FlexBox, {
      className: className,
      style: this.props.style
